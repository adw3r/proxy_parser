...
class TestProxyParser:
    ...
    async def test_fetch_source_empty_response(self, parser):
        ...
        with patch('proxy_parser.parsers.http_client') as mock_client:
            mock_client.get_text.return_value = None
    ...
    async def test_fetch_source_with_proxies(self, parser):
        ...
        with patch('proxy_parser.parsers.http_client') as mock_client:
            mock_client.get_text.return_value = sample_text
    ...
    def test_update_sources(self, parser):
        ...
        with patch('proxy_parser.parsers.github_client') as mock_github, \
            ...
            mock_github.search_files.return_value = ["http://github.com/file1", "http://github.com/file2"]
